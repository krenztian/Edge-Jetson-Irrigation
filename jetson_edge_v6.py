    ...
    <head>
        ...
        <style>
            ...
            * {{ margin: 0; padding: 0; box-sizing: border-box; }}
            ...
            .sensor-status.online .sensor-status-dot {{ background: var(--success); }}
            .sensor-status.online {{ color: var(--success); }}
            .sensor-status.standby .sensor-status-dot {{ background: #F59E0B; }}
            .sensor-status.standby {{ color: #F59E0B; }}
                ...
                <div class="sensors-section">
                    <div class="section-header">
                        ...
                        <span class="section-title">
                            ...
                            <span style="font-size: 0.7rem; font-weight: normal; margin-left: 8px;">
                                {f'<span style="color: #10B981;">● <span data-en="Live" data-th="สด">Live</span></span>' if live_data_source == "live" else f'<span style="color: #F59E0B;">● <span data-en="Restored" data-th="กู้คืน">Restored</span></span>' if live_data_source == "restored" else '<span style="color: #9CA3AF;">● <span data-en="Waiting" data-th="รอข้อมูล">Waiting</span></span>'}
                                <span style="color: var(--gray-500); margin-left: 4px;"><span data-en="Collected" data-th="เก็บข้อมูลเมื่อ">Collected</span>: {live_data_timestamp}</span>
                            </span>
                        </span>
                    </div>
                    <div class="sensor-grid">
                        <div class="sensor-card">
                            ...
                            <div style="font-size: 0.7rem; color: var(--gray-500);"><span data-en="Max" data-th="สูงสุด">Max</span> | <span data-en="Min" data-th="ต่ำสุด">Min</span>: {current_temp_min:.2f}°C</div>
...
if __name__ == "__main__":
    uvicorn.run("jetson_edge_v6:app", host="0.0.0.0", port=8000, log_level="info", reload=False)
